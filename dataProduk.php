...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="dataProduk.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <p><a class="btn btn-primary" href="tambahProduk.php">Tambah Produk</a></p>
      <div class="col-md-12">
        <table class="table table-striped table-bordered table-sm" cellspacing="0";>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center "><a class="btn btn-primary btn-sm"  href="editProduk.php?id=<?php echo $row['produk_id']?>">Edit</a>  <a class="btn btn-danger btn-sm" href="hapus.php?idp=<?php echo $row['produk_id']?>" onclick="return confirm('Apakah anda Yakin?')" >Hapus</a></td>
