      ...
      <div id="carouselExampleIndicators" class="carousel slide mt-3 shadow-sm " data-bs-ride="carousel">
        ...
        <div class="carousel-inner rounded-2">
          <div class="carousel-item active">
            <img src="../project/foto/cupang2f.jpg" class="d-block img-fluid" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../project/foto/cupang1f.jpg" class="d-block  img-fluid" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../project/foto/cupang4f.jpg" class="d-block  img-fluid" alt="...">
          </div>
        </div>
          ...
          <div class="row text-center row-container shadow-sm mt-2 rounded-2">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6 shadow-sm ">
                  <div class="menu-kategori ">
                      <a href="produk.php?kat=<?php echo $k['kategori_id'] ?>"><img src="kategoriss.png" class="img-kategori mt-3"></a>
            ...
            <div class="card text-center">
              ...
              <div class="card-body">
                ...
                <?php if($p['produk_status']== '1'){?>
                  ...
                  <?php }else{?>
                    <p class="card-text" style="font-size:14px;" >Kosong <i class="fa-solid fa-xmark"></i></p>
                   <a href="gagal.php"<?php echo $p['produk_id'] ?>" class="btn btn-primary  d-grid">Beli</a>
                   <?php } ?>
